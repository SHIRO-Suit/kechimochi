...
// Spread across 2025-01 to 2025-03
function generateActivityLogs(mediaIds: Map<string, number>) {
  ...
  const entries: [string, number, string][] = [
    // [title, minutes, date]
    ['ある魔女が死ぬまで', 45, '2025-01-05'],
    ['ある魔女が死ぬまで', 60, '2025-01-08'],
    ['ある魔女が死ぬまで', 30, '2025-01-12'],
    ['薬屋のひとりごと', 40, '2025-01-06'],
    ['薬屋のひとりごと', 55, '2025-01-10'],
    ['薬屋のひとりごと', 35, '2025-01-15'],
    ['呪術廻戦', 25, '2025-01-07'],
    ['呪術廻戦', 20, '2025-01-14'],
    ['ハイキュー!!', 24, '2025-01-09'],
    ['ハイキュー!!', 24, '2025-01-16'],
    ['STEINS;GATE', 90, '2025-01-11'],
    ['STEINS;GATE', 120, '2025-01-18'],
    ['ペルソナ5', 60, '2025-01-13'],
    ['ペルソナ5', 45, '2025-01-20'],
    ['本好きの下剋上', 50, '2025-02-01'],
    ['本好きの下剋上', 65, '2025-02-05'],
    ['本好きの下剋上', 40, '2025-02-10'],
    ['葬送のフリーレン', 24, '2025-02-03'],
    ['葬送のフリーレン', 24, '2025-02-08'],
    ['葬送のフリーレン', 24, '2025-02-15'],
    ['WHITE ALBUM 2', 75, '2025-02-04'],
    ['ダンジョン飯', 30, '2025-02-06'],
    ['ある魔女が死ぬまで', 55, '2025-02-12'],
    ['薬屋のひとりごと', 45, '2025-02-18'],
    ['ペルソナ5', 90, '2025-02-20'],
    ['本好きの下剋上', 70, '2025-03-01'],
    ['ある魔女が死ぬまで', 40, '2025-03-03'],
    ['葬送のフリーレン', 24, '2025-03-05'],
    ['薬屋のひとりごと', 50, '2025-03-07'],
    ['ペルソナ5', 60, '2025-03-08'],
  ];
